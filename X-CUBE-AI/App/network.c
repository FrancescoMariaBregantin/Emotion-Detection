...
#define AI_NETWORK_MODEL_SIGNATURE     "0x57b51a640c4cb75cea5c027da74b11e1"
...
#define AI_TOOLS_DATE_TIME   "Fri Jun 14 16:36:55 2024"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  2, 0x0,
  AI_SHAPE_INIT(4, 252, 64, 1, 1), AI_STRIDE_INIT(4, 4, 1008, 64512, 64512),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  8, 0x0,
  AI_SHAPE_INIT(4, 1, 252, 1, 1), AI_STRIDE_INIT(4, 4, 4, 1008, 1008),
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
    AI_BUFFER_SHAPE_INIT(AI_SHAPE_BCWH, 4, 1, 81668, 1, 1),
    81668, NULL, NULL),
  AI_BUFFER_INIT(AI_FLAG_NONE,  AI_BUFFER_FORMAT_U8,
  ...
  &dense_2_dense_layer, 0x66111fb3, NULL)
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_activations_map(g_network_activations_map, 1, params)) {
    ...
    dense_2_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 1008);
    dense_2_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 1008);
    ...
    dense_4_dense_output_array.data = AI_PTR(g_network_activations_map[0] + 256);
    dense_4_dense_output_array.data_start = AI_PTR(g_network_activations_map[0] + 256);
  ...
  ai_network* net_ctx, const ai_network_params* params)
{
  ...
  if (ai_platform_get_weights_map(g_network_weights_map, 1, params)) {
    ...
    dense_2_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 64512);
    dense_2_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 64512);
    dense_3_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_3_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 64768);
    dense_3_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 64768);
    dense_3_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_3_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 81152);
    dense_3_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 81152);
    dense_4_dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_4_dense_weights_array.data = AI_PTR(g_network_weights_map[0] + 81408);
    dense_4_dense_weights_array.data_start = AI_PTR(g_network_weights_map[0] + 81408);
    dense_4_dense_bias_array.format |= AI_FMT_FLAG_CONST;
    dense_4_dense_bias_array.data = AI_PTR(g_network_weights_map[0] + 81664);
    dense_4_dense_bias_array.data_start = AI_PTR(g_network_weights_map[0] + 81664);
    return true;
  }
